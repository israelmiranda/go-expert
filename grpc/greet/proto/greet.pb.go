...
const file_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x122\n" +
	"\x05Greet\x12\x13.proto.GreetRequest\x1a\x14.proto.GreetResponse\x12=\n" +
	"\x0eGreetManyTimes\x12\x13.proto.GreetRequest\x1a\x14.proto.GreetResponse0\x01\x128\n" +
	"\tLongGreet\x12\x13.proto.GreetRequest\x1a\x14.proto.GreetResponse(\x01B5Z3github.com/israelmiranda/go-expert/grpc/greet/protob\x06proto3"
...
var file_greet_proto_depIdxs = []int32{
	...
	0, // 1: proto.GreetService.GreetManyTimes:input_type -> proto.GreetRequest
	0, // 2: proto.GreetService.LongGreet:input_type -> proto.GreetRequest
	1, // 3: proto.GreetService.Greet:output_type -> proto.GreetResponse
	1, // 4: proto.GreetService.GreetManyTimes:output_type -> proto.GreetResponse
	1, // 5: proto.GreetService.LongGreet:output_type -> proto.GreetResponse
